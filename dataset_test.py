...
if __name__ == '__main__':
    ds = TCWVDataset('tcwv05', split="test", subsample_step=1, pred_length=5,
        standardize=False) # Without standardization
    init_states, target_states, static_features, forcing_windowed = ds[0]
    ...
    print(f'forcing_windowed: {forcing_windowed.shape}')
